...
def parse_options():
    ...
    parser.add_argument("-p", "--param1", dest="param1", required=True, help="parameters file 1")
    parser.add_argument("-q", "--param2", dest="param2", required=True, help="parameters file 2")
...
def main():
    ...
    with plt.style.context("fivethirtyeight"):
        plt.hist(msa_energies - standard_energy1, alpha=.5, label="MSA", density=True)
        plt.hist(mcmc_energies - standard_energy2, alpha=.5, label="MCMC", density=True)
